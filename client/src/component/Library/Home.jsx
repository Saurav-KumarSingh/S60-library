    ...
    <>
        ...
        <div>
          ...
          >
            <div class="pr-2 md:mb-14 py-14 md:py-0">
              ...
              >
                <span class="block w-full font-mulli">There Is No Friend </span>
                As Loyal As a Book
              </h1>
              ...
              <a
                  href=""
                  class="flex text-indigo-700 hover:bg-indigo-700 hover:text-white border border-indigo-600 py-2 px-6 gap-2 rounded  items-center"
                >
                  <span>View More</span>
                  <svg
                    className="w-4"
      ...
      <div class=" w-full">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8  lg:py-20">
          ...
          <div class="mt-10 text-center grid-cols-4 sm:mx-auto sm:grid sm:grid-cols-4 sm:gap-8">
            <div class="flex flex-col">
              <Link><img src="./SEMESTER-1.png" alt="" /></Link>
            </div>
            <div class="flex flex-col">
              <Link><img src="./SEMESTER-II.png" alt="" /></Link>
            </div>
            <div class="flex flex-col">
              <Link><img src="./SEMESTER-III.png" alt="" /></Link>
            </div>
            <div class="flex flex-col">
              <Link><img src="./SEMESTER-IV.png" alt="" /></Link>
            </div>
            <div class="flex flex-col">
              <Link><img src="./SEMESTER-V.png" alt="" /></Link>
            </div>
            <div class="flex flex-col">
              <Link><img src="./SEMESTER-VI.png" alt="" /></Link>
            </div>
            <div class="flex flex-col">
              <Link><img src="./SEMESTER-VII.png" alt="" /></Link>
            </div>
            <div class="flex flex-col">
              <Link><img src="./SEMESTER-VIII.png" alt="" /></Link>
            </div>
          </div>
        </div>
      </div>
