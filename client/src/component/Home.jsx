    ...
    <div>
        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8  lg:py-20">
          ...
          <div class="mt-10 text-center grid-cols-4 sm:mx-auto sm:grid sm:grid-cols-4 sm:gap-8">
            ...
            <div class="flex flex-col mt-10 sm:mt-0">
              ...
              <dd class="order-1 text-7xl font-bold text-orange-400 ">10+</dd>
            </div>
            <div class="flex flex-col mt-10 sm:mt-0">
              <dt class="order-2 mt-2 text-lg leading-6 font-medium ">
                PYQ
              </dt>
              <dd class="order-1 text-7xl font-bold text-orange-400 ">20+</dd>
            </div>
            <div class="flex flex-col mt-10 sm:mt-0">
              <dt class="order-2 mt-2 text-lg leading-6 font-medium ">
                Road MAPS
              </dt>
              <dd class="order-1 text-7xl font-bold text-orange-400 ">50</dd>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class=" w-full">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8  lg:py-20">
          ...
          <div class="mt-10 text-center grid-cols-4 sm:mx-auto sm:grid sm:grid-cols-3 sm:gap-8">
            
            <div class="flex flex-col p-5">
              <Link to='/library/PYQ/sem-3'><img src="./sem3.jpg" alt="" /></Link>
            </div>
            <div class="flex flex-col p-5">
              <Link to='/library/PYQ/sem-4'><img src="./sem4.jpg" alt="" /></Link>
            </div>
            <div class="flex flex-col p-5">
              <Link to='/library/PYQ/sem-5'><img src="./sem5.jpg" alt="" /></Link>
            </div>
            <div class="flex flex-col p-5">
              <Link to='/library/PYQ/sem-6'><img src="./sem6.jpg" alt="" /></Link>
            </div>
            <div class="flex flex-col p-5">
              <Link to='/library/PYQ/sem-7/8' ><img src="./sem7.jpg" alt="" /></Link>
            </div>
            <div class="flex flex-col p-5">
              <Link to='/library/PYQ/sem-7/8'><img src="./sem8.jpg" alt="" /></Link>
            </div>
          </div>
        </div>
      </div>
